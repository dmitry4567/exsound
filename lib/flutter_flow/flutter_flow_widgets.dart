...
class _FFButtonWidgetState extends State<FFButtonWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    ButtonStyle style = ButtonStyle(
      ...
      padding: WidgetStateProperty.all(widget.options.padding ?? const EdgeInsets.symmetric(horizontal: 8.0, vertical: 4.0)),
      elevation: WidgetStateProperty.all<double>(widget.options.elevation ?? 2.0),
    );
